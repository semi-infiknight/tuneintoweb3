...
- Use Fuji testnet before mainnet deployment.
- Keep dependencies up to date.
- Document your code and architecture.

## Resources
- [OpenZeppelin Contracts](https://docs.openzeppelin.com/contracts/)
- [Avalanche Security Best Practices](https://docs.avax.network/build/tutorials/platform/security-best-practices/)